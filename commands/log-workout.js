...
module.exports = {
    ...
    data: new SlashCommandBuilder()
        .setName("log-workout")
        .setDescription("logs a full workout"),
            ...
            try {
                ...
                if (people[person]) {
                    ...
                    //Lets them know if they've already logged for the day
                        ...
                        replyMessage = 'You\'ve already done your workout for today, so your streak is safe!';
                    }
                ...
                //If not, add it to the file
                    ...
                    personSetup = [1, 1, true, true, name, false, 0, 1, 1, false, "This is where you'd put your description"];
